...
</br>- Выполнение бизнесовых/продуктовых задач, в том числе с применением А/B тестирования.
</br>- Занимался аналитикой бизнес задач, с дальнейшей декомпозицией для внесения в спринт, с оценкой.
</br>- Проводил разработку и согласование контрактов между фронтендом и бэкендом при проектировании bff-сервисов. 
</br>- Проведение код ревью.
</br>- Работа с legacy-кодом для дальнейшего избавления от него.
</br>- Являлся ментором во внутренней программе стажировки по направлению "PHP разработчик".
</br>- Принимал активное участие в настраивании процессов разработки и деятельности команды на ≈10 человек 
* **июль 2025 - ноябрь 2025** - пребывал в отпуске
* **ноябрь 2025 - наст. время** - [ФИНФОРТ](https://finfort.ru/). Занимался Backend разработкой(PHP).
</br> - Доработка существующего функционала на Symfony 4-6.
</br> - Работа с очередями RabbitMQ, в том числе с retry политиками.
</br> - Применение ИИ для решения рутинных задач и предварительного код-ревью, написания тестов.
</br> - Генерация документации openapi.
</br> - Участие в оценке и планировании задач.
